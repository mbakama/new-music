            ...
            <div class="row g-5">
              ...
              <div class="col-lg-8">
                ...
                <div class="comments">
                  ...
                  <h4 class="comments-count">@if ($post->comments->count()>0)
                    {{ $post->comments->count() }}
                @endif Comments</h4>
                ...
                <div class="sidebar">
                  ...
                  <div class="sidebar-item categories">
                    ...
                    <ul class="mt-3">
                      ...
                      <li><a href="#">{{ $categorie->categorie_name }} <span>({{ $categorie->post_count }})</span></a></li>
                  ...
                  <div class="sidebar-item recent-posts">
                    ...
                    <div class="post-item">
                      ...
                      <div>
                        <h4><a href="blog-details.html">{{ $post->titre }}</a></h4>
                        <time datetime="2020-01-01">{{ $post->formatted_date }}</time>
                      </div>
