...
!(function (t, e) {
  ...
  function ve(t, e, i, s, n) {
    ...
    if (!(isNaN(f) || f <= 0)) {
      switch ((t.beginPath(), d)) {
        default:
          n ? t.ellipse(i, s, n / 2, f, 0, 0, At) : t.arc(i, s, f, 0, At),
            t.closePath();
          break;
        case "triangle":
    ...
    for (const r of t) {
      ...
      if (r.horizontal) {
        ...
        ut(l.start) && (a = l.start),
          t.fullSize
            ? Ui(t, n.left, a, i.outerWidth - n.right - n.left, o)
            : Ui(t, e.left + l.placed, a, s, o),
          (l.start = a),
          (l.placed += s),
          (a = t.bottom);
      } else {
        ...
        ut(l.start) && (o = l.start),
          t.fullSize
            ? Ui(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
            : Ui(t, o, e.top + l.placed, a, s),
          (l.start = o),
          (l.placed += s),
          (o = t.right);
      }
  ...
  function is(t, e, i) {
    const s = t.canvas,
      n = new MutationObserver((t) => {
        let e = !1;
        for (const i of t)
          (e = e || es(i.addedNodes, s)), (e = e && !es(i.removedNodes, s));
        e && i();
      });
  ...
  function ss(t, e, i) {
    const s = t.canvas,
      n = new MutationObserver((t) => {
        let e = !1;
        for (const i of t)
          (e = e || es(i.removedNodes, s)), (e = e && !es(i.addedNodes, s));
        e && i();
      });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
  }
  ...
  class cs extends Ki {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        s = i[e];
      if (!s) return;
      (({ attach: ls, detach: ls, resize: ls })[e] || ts)(t, e, s),
        (i[e] = void 0);
    }
    getDevicePixelRatio() {
  ...
  function ks(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: o, [h]: d } = i;
      (u = (i._stacks || (i._stacks = {}))[h] = ws(n, c, o)),
        (u[r] = d),
  ...
  class Os {
    ...
    buildOrUpdateElements(t) {
      ...
      (e._stacked = vs(e.vScale, e)),
        ...
        (s || n !== e._stacked) && ks(this, e._parsed);
    }
    configure() {
    ...
    applyStack(t, e, i) {
      const s = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return ys({ keys: _s(s, !0), values: e._stacks[t.axis] }, o, n.index, {
        mode: i,
      });
    }
    updateRangeFromParsed(t, e, i, s) {
      ...
      s && a && ((s.values = a), (o = ys(s, n, this._cachedMeta.index))),
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        r = ((t, e, i) =>
          t && !e.hidden && e._stacked && { keys: _s(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        f.$shared && ((f.$shared = r), (n[o] = Object.freeze(Cs(f, r)))), f
      );
    }
  ...
  (Os.defaults = {}),
    (Os.prototype.datasetElementType = null),
    (Os.prototype.dataElementType = null);
  class As {
    constructor() {
      (this.x = void 0),
        (this.y = void 0),
  ...
  function Rs(t, e) {
    ...
    if (o > 0) {
      ...
      for (Es(e, l, h, U(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++)
        Es(e, l, h, n[t], n[t + 1]);
  ...
  class Ns extends As {
    ...
    fit() {
      ...
      if (o) {
        ...
        if (
          (a
            ? ((t.width = this.maxWidth), (t.height = Bs(n) + o))
            : ((t.height = this.maxHeight), (t.width = Bs(n) + o)),
      ...
      const {
        ...
        if (t.isHorizontal()) {
          if (((f = n(s, a, l)), q(i))) {
            ...
            g = "center" === i ? (c.bottom + c.top) / 2 + m - e : Is(t, i, e);
          u = l - a;
        } else {
          if (q(i)) {
            const t = Object.keys(i)[0],
            ...
            f = "center" === i ? (c.left + c.right) / 2 - b + e : Is(t, i, e);
        ...
        ? (function (t, { plugins: e, localIds: i }, s, n) {
            ...
            for (const r of e) {
              ...
              null !== l &&
                o.push({
                  plugin: r,
                  options: Us(t.config, { plugin: r, local: i[e] }, l, a),
                });
            }
            return o;
          })(t, n, s, e)
  ...
  class en {
    ...
    getOptionScopes(t, e, i) {
      ...
      const r = new Set();
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => tn(r, t, e))),
          e.forEach((t) => tn(r, s, t)),
          e.forEach((t) => tn(r, mt[n] || {}, t)),
          e.forEach((t) => tn(r, yt, t)),
          e.forEach((t) => tn(r, bt, t));
      });
  ...
  class gn {
    constructor(t, e) {
      ...
      (this.platform = new (s.platform || ds(n))()),
      ...
      (this.id = Y()),
        ...
        (dn[this.id] = this),
        l && h
          ? (a.listen(this, "complete", ln),
            a.listen(this, "progress", hn),
            this._initialize(),
      ...
      e &&
        ...
        et(n, (e) => {
          const n = e.options,
            ...
            a = qs(o, n),
            r = Z(n.type, e.dtype);
          (void 0 !== n.position && an(n.position, a) === an(e.dposition)) ||
      ...
      for (let u = e; u < e + i; u++) {
        const e = this.getParsed(u),
          ...
          p = {
            ...
            base: i.base,
            enableBorderRadius:
              !g || Mn(e._custom) || o === g._top || o === g._bottom,
            x: l ? i.head : f.center,
            y: l ? f.center : i.head,
      ...
      for (let f = e; f < e + i; ++f) {
        const e = t[f],
          ...
          v = (x[u] =
            n || _
              ? a.getBasePixel()
              : a.getPixelForValue(r ? this.applyStack(a, i, r) : i[u], f));
        (x.skip = isNaN(y) || isNaN(v) || _),
          (x.stop = f > 0 && Math.abs(i[d] - b[d]) > p),
          g && ((x.parsed = i), (x.raw = l.data[f])),
          c &&
            (x.options =
              h || this.resolveDataElementOptions(f, e.active ? "active" : s)),
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            o !== n &&
            (ko(t, s, a.top),
            So(t, { line: i, target: s, color: n, scale: r, property: l }),
            t.restore(),
            t.save(),
            ko(t, s, a.bottom));
        So(t, { line: i, target: s, color: o, scale: r, property: l }),
          t.restore();
      })(t, {
        line: n,
        target: s,
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (a = 0; a < s; ++a)
        (o = t.getDatasetMeta(a)),
          ...
          n.push(l);
      for (a = 0; a < s; ++a)
        (l = n[a]), l && !1 !== l.fill && (l.fill = bo(n, a, i.propagate));
    },
    beforeDraw(t, e, i) {
    ...
    getContext() {
      return (
        ...
        (this.$context =
          ...
          mi(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
      );
      var t, e, i;
    }
    getTitle(t, e) {
      ...
      return (
        et(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            n = Uo(i, t);
          Fo(e.before, Bo(n.beforeLabel.call(this, t))),
            Fo(e.lines, n.label.call(this, t)),
            Fo(e.after, Bo(n.afterLabel.call(this, t))),
            s.push(e);
        }),
        s
      );
      ...
      return ((t, e) =>
        null === t
          ...
          : Qt(
              ...
              0,
              e
            ))((e = isFinite(e) && i[e] === t ? e : Go(i, t, Z(e, t), this._addedLabels)), i.length - 1);
    }
    determineDataLimits() {
  ...
  (Zo.id = "category"),
    (Zo.defaults = { ticks: { callback: Zo.prototype.getLabelForValue } });
  class Qo extends Ns {
    constructor(t) {
      super(t),
        (this.start = void 0),
      ...
      const s = (function (t, e) {
        ...
        for (
          ...
          (d && v !== o
            ? (i.push({ value: o }),
              v < o && P++,
              jt(Math.round((v + P * k) * y) / y, o, Jo(o, _, t)) && P++)
            : v < o && P++);
          P < M;
          ++P
        )
        ...
        return (
          b && d && w !== a
            ? i.length && jt(i[i.length - 1].value, a, Jo(a, _, t))
  ...
  (ta.id = "linear"),
    (ta.defaults = { ticks: { callback: Ls.formatters.numeric } });
  class ia extends Ns {
    constructor(t) {
      super(t),
        (this.start = void 0),
  ...
  (ia.id = "logarithmic"),
    (ia.defaults = {
      ticks: { callback: Ls.formatters.logarithmic, major: { enabled: !0 } },
    });
  class da extends Qo {
    constructor(t) {
      super(t),
      ...
      return (
          ...
          (i.autoSkip
            ...
            : (function (t, e, i, s, n) {
                for (let o = fa.length - 1; o >= fa.indexOf(i); o--) {
                  const i = fa[o];
                  if (ua[i].common && t._adapter.diff(n, s, i) >= e - 1)
                    return i;
                }
        ...
        (this._majorUnit =
          i.major.enabled && "year" !== this._unit
            ? (function (t) {
                for (let e = fa.indexOf(t) + 1, i = fa.length; e < i; ++e)
                  if (ua[fa[e]].common) return fa[e];
              })(this._unit)
            : void 0),
        this.initOffsets(s),
        t.reverse && o.reverse(),
  ...
  class va extends _a {
    ...
    initOffsets() {
      ...
      (this._minPos = ya(e, this.min)),
        (this._tableRange = ya(e, this.max) - this._minPos),
        super.initOffsets(t);
    }
    buildLookupTable(t) {
